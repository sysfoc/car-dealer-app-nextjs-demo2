...
const Modal = ({ show, onClose, children, size = "md" }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black bg-opacity-50 flex items-center justify-center p-4">
      <div className={`relative bg-white rounded-2xl shadow-xl w-full ${sizeClasses[size]} mx-auto`}>
...
const ModalHeader = ({ children }) => (
  <div className="border-b border-gray-200 p-6 sticky top-0 bg-white rounded-t-2xl z-10">{children}</div>
)

const ModalBody = ({ children, className = "" }) => (
  <div className={`p-6 overflow-y-auto max-h-[80vh] ${className}`}>{children}</div>
)
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex h-64 items-center justify-center">
            <div className="text-center">
              ...
              <span className="text-lg font-medium text-slate-600">Loading contact messages...</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          {currentMessages.length === 0 ? (
            <div className="rounded-2xl border border-gray-200 bg-white p-12 text-center shadow-sm">
              ...
              <h3 className="mb-2 text-lg font-semibold text-gray-900">No messages found</h3>
              ...
              <>
                ...
                {selectedMessage.adminReply && (
                  <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                    ...
                    <p className="text-sm text-green-700 whitespace-pre-wrap">{selectedMessage.adminReply}</p>
                  </div>
                )}
              </>
            )}
