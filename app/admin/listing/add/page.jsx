      ...
      <div className="mt-5">
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          ...
          <div className="grid grid-cols-1 gap-x-5 gap-y-3 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div>
              <Label htmlFor="price">Price:</Label>
              <TextInput id="price" name="price" type="number" value={formData.price} onChange={handleChange} />
            </div>
            <div>
              <Label htmlFor="type">Type:</Label>
          ...
          <div className="mt-5">
            ...
            <div className="grid grid-cols-1 gap-x-5 gap-y-3 sm:grid-cols-2 md:grid-cols-3">
              <div>
                <Label htmlFor="total-driven">Total Driven (in km):</Label>
                <TextInput id="total-driven" type="number" name="kms" value={formData.kms} onChange={handleChange} />
              </div>
              <div>
                <Label htmlFor="fuel-type">Fuel Type:</Label>
                <Select id="fuel-type" name="fuelType" value={formData.fuelType} onChange={handleChange}>
                  <option value="petrol"> Petrol (Gasoline)</option>
                  <option value="diesel">Diesel</option>
                  <option value="Electric">Electric</option>
              ...
              <div>
                <Label htmlFor="gearbox">Gear Box:</Label>
                <Select id="gearbox" name="gearbox" value={formData.gearbox} onChange={handleChange}>
                  <option value="manual">Manual</option>
                  <option value="automatic">Automatic</option>
              ...
              <div>
                <Label htmlFor="noOfGears">No of Gears:</Label>
                <Select id="noOfGears" name="noOfGears" value={formData.noOfGears} onChange={handleChange}>
                  <option value="">Select</option>
                  <option value="4">4-speed Manual</option>
                  <option value="5">5-speed Manual</option>
                  <option value="6">6-speed Manual</option>
              ...
              <div>
                <Label htmlFor="cylinder">Cylinders:</Label>
                <Select id="cylinder" name="cylinder" value={formData.cylinder} onChange={handleChange}>
                  <option value="">Select</option>
                  <option value="2">2 Cylinders</option>
                  <option value="3">3 Cylinders</option>
                  <option value="4">4 Cylinders</option>
              ...
              <div>
                <Label htmlFor="BodyType">Body Type:</Label>
                <Select id="BodyType" name="bodyType" value={formData.bodyType} onChange={handleChange}>
                  <option value="">Select Body Type</option>
                  <option value="Sedan">Sedan</option>
                  <option value="Hatchback">Hatchback</option>
              ...
              <div>
                <Label htmlFor="color">Color:</Label>
                <TextInput id="color" type="text" name="color" value={formData.color} onChange={handleChange} />
              </div>
              <div>
                <Label htmlFor="location">Location:</Label>
                <TextInput
              ...
              <div>
                <Label htmlFor="year">Build Date:</Label>
                <TextInput id="year" type="text" name="year" value={formData.year} onChange={handleChange} />
              </div>
              <div>
                <Label htmlFor="modelYear">Model Year:</Label>
                <TextInput
              ...
              <div>
                ...
                <TextInput id="mileage" type="text" name="mileage" value={formData.mileage} onChange={handleChange} />
              </div>
              <div>
                <Label htmlFor="unit">Select Default Unit:</Label>
                <Select id="unit" name="unit" value={formData.unit} onChange={handleChange} className="mt-1">
                  <option value="km">Kilometers (km)</option>
                  <option value="miles">Miles</option>
                </Select>
              </div>
              ...
              <div>
                ...
                <TextInput id="video" type="url" name="video" value={formData.video} onChange={handleChange} />
              </div>
              <div>
                <Label htmlFor="slug">Slug (Optional):</Label>
                <TextInput id="slug" type="text" name="slug" value={formData.slug} onChange={handleChange} />
              </div>
            </div>
          </div>
          <div className="mt-5">
