...
export default function SellMyCar() {
  ...
  const guides = [
    ...
    },
    {
      ...
      description: "Understand current market trends and how they affect your vehicle's value.",
      color: "from-green-500 to-emerald-500"
    },
    {
      icon: <MdOutlinePayments className="text-4xl text-purple-500" />,
  ...
  const faqs = [
    {
      ...
      answer: "Our platform connects you with automotive professionals who specialize in vehicle sales. You contact our team, we assess your vehicle, and then help facilitate the sale through our network of dealers and professionals. All transactions are handled with professional oversight for your security."
    },
    {
      question: "What documents do I need to sell my car?",
      answer: "You will need your vehicle title, registration, maintenance records, and if applicable, your loan payoff information. Our team will guide you through exactly what's required in your state during the consultation process."
    },
    {
      question: "How is my car value determined?",
      answer: "Our automotive experts use comprehensive market analysis including recent sales data, current market trends, vehicle condition, mileage, and location to provide the most accurate valuation for your specific vehicle."
    },
    {
      question: "Is it safe to sell my car through your platform?",
      answer: "Absolutely. All sales are facilitated through our network of verified automotive professionals. We provide consultation, professional assessment, and transaction oversight to ensure a secure and smooth selling experience."
    },
    {
      question: "How long does the selling process typically take?",
      answer: "The timeline varies depending on your vehicle and market conditions. Our team will provide you with realistic expectations during the initial consultation and work to facilitate the sale as efficiently as possible."
    }
  ];
  ...
  <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-24">
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-2">
          <div className="space-y-8">
            <div className="inline-flex items-center rounded-full bg-blue-500/10 px-4 py-2 backdrop-blur-sm">
              <FaStar className="mr-2 text-yellow-400" />
              <span className="text-sm font-medium text-blue-100">Trusted automotive services</span>
            </div>
            
            <div className="space-y-6">
              <h1 className="text-5xl font-bold leading-tight text-white lg:text-6xl">
                We Sell Cars
                <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent"> Professionally</span>
              </h1>
              <p className="text-xl text-blue-100 lg:text-2xl">
                Learn about our professional car selling services. Our automotive experts help you navigate the selling process with confidence and security.
              </p>
               <button
    ...
    <section className="py-20 bg-gray-50 dark:bg-gray-800">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Our professional team guides you through every step of the car selling process. Here's how we help you sell your vehicle with confidence.
          </p>
        </div>
    ...
    <section className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-cyan-600 py-20">
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
          Contact our automotive experts today to learn more about our professional car selling services and get expert guidance for your vehicle.
        </p>
