...
//                 <span className="rounded-full bg-blue-600 px-3 py-1.5 text-xs font-bold uppercase text-white shadow-lg backdrop-blur-sm">
//                   {car.condition && car.condition !== "Select"
//                     ? car.condition
//                     : car.type || "Used"}
//                 </span>
//                 {car.isFinance && car.isFinance !== "km" && (
//                   <span className="rounded-full bg-emerald-500 px-3 py-1.5 text-xs font-bold uppercase text-white shadow-lg backdrop-blur-sm">
//                     {car.isFinance}
//                   </span>
//                 )}
//               </div>
...
//                 {Array.isArray(car.imageUrls) && car.imageUrls.length > 1 && (
//                   <div className="rounded-full bg-black/70 px-2.5 py-1 text-xs font-medium text-white backdrop-blur-sm">
//                     1/{car.imageUrls.length}
//                   </div>
//                 )}
//                 <button className="flex h-10 w-10 items-center justify-center rounded-full bg-white/90 shadow-lg backdrop-blur-sm transition-transform hover:scale-110 dark:bg-gray-800/90">
//                   <CiHeart
//                     size={22}
...
//                   {(car.year || car.modelYear) && (
//                     <div className="mt-2">
//                       <span className="inline-flex items-center rounded-lg bg-slate-100 px-2.5 py-1 text-xs font-semibold text-slate-700 dark:bg-gray-700 dark:text-gray-300">
//                         {car.year || car.modelYear} Model
//                       </span>
//                     </div>
//                   )}
...
//                   }`}
//                 >
//                   <div className="flex items-center gap-2.5 rounded-lg bg-slate-50 p-2.5 dark:bg-gray-700/50">
//                     <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-blue-100 dark:bg-blue-900/30">
//                       <FaLocationCrosshairs className="h-4 w-4 text-blue-600 dark:text-blue-400" />
//                     </div>
//                     <div className="min-w-0 flex-1">
//                       <p className="text-[10px] font-medium uppercase leading-tight tracking-wide text-slate-500 dark:text-gray-400">
//                         Location
//                       </p>
//                       <p className="break-words text-xs font-semibold leading-tight text-gray-900 dark:text-white">
//                         {car.location || "Not specified"}
//                       </p>
//                     </div>
//                   </div>
...
//                       <IoSpeedometer className="h-4 w-4 text-emerald-600 dark:text-emerald-400" />
//                     </div>
//                     <div className="min-w-0 flex-1">
//                       <p className="text-[10px] font-medium uppercase leading-tight tracking-wide text-slate-500 dark:text-gray-400">
//                         Mileage
...
//                       <GiGasPump className="h-4 w-4 text-amber-600 dark:text-amber-400" />
//                     </div>
//                     <div className="min-w-0 flex-1">
//                       <p className="text-[10px] font-medium uppercase leading-tight tracking-wide text-slate-500 dark:text-gray-400">
//                         Fuel
...
//                   <div className="flex items-center gap-2.5 rounded-lg bg-slate-50 p-2.5 dark:bg-gray-700/50">
//                     <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-rose-100 dark:bg-rose-900/30">
//                       <IoIosColorPalette className="h-4 w-4 text-rose-600 dark:text-rose-400" />
//                     </div>
//                     <div className="min-w-0 flex-1">
//                       <p className="text-[10px] font-medium uppercase leading-tight tracking-wide text-slate-500 dark:text-gray-400">
//                         Color
...
//                   <div className="flex items-center gap-2.5 rounded-lg bg-slate-50 p-2.5 dark:bg-gray-700/50">
//                     <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-indigo-100 dark:bg-indigo-900/30">
//                       <GiCarSeat className="h-4 w-4 text-indigo-600 dark:text-indigo-400" />
//                     </div>
//                     <div className="min-w-0 flex-1">
//                       <p className="text-[10px] font-medium uppercase leading-tight tracking-wide text-slate-500 dark:text-gray-400">
//                         Seats
                ...
                <div className="flex-1 pr-3">
                  ...
                  {(car.year || car.modelYear) && (
                    <div className={`${isGridView ? "mt-1" : "mt-2"}`}>
                      <span className={`inline-flex items-center rounded-lg bg-slate-100 px-2 py-0.5 font-semibold text-slate-700 dark:bg-gray-700 dark:text-gray-300 ${
              ...
              <div className={`flex-1 ${isGridView ? "mb-3" : "mb-4"}`}>
                ...
                >
                  <div className="flex items-center gap-2 rounded-lg bg-slate-50 p-2 dark:bg-gray-700/50">
                    <div className={`flex flex-shrink-0 items-center justify-center rounded-lg bg-blue-100 dark:bg-blue-900/30 ${
                      isGridView ? "h-6 w-6" : "h-8 w-8"
                    }`}>
                      <FaLocationCrosshairs className={`text-blue-600 dark:text-blue-400 ${
                        isGridView ? "h-3 w-3" : "h-4 w-4"
                      }`} />
                    </div>
                    <div className="min-w-0 flex-1">
                      <p className={`font-medium uppercase leading-tight tracking-wide text-slate-500 dark:text-gray-400 ${
                        isGridView ? "text-[9px]" : "text-[10px]"
                      }`}>
                        Location
                      </p>
                      <p className={`break-words font-semibold leading-tight text-gray-900 dark:text-white ${
                        isGridView ? "text-xs" : "text-xs"
                      }`}>
                        {car.location ? (car.location.length > 12 ? `${car.location.substring(0, 12)}...` : car.location) : "Not specified"}
                      </p>
                    </div>
                  </div>

                  <div className="flex items-center gap-2 rounded-lg bg-slate-50 p-2 dark:bg-gray-700/50">
                    <div className={`flex flex-shrink-0 items-center justify-center rounded-lg bg-emerald-100 dark:bg-emerald-900/30 ${
                      isGridView ? "h-6 w-6" : "h-8 w-8"
                    }`}>
                      <IoSpeedometer className={`text-emerald-600 dark:text-emerald-400 ${
                        isGridView ? "h-3 w-3" : "h-4 w-4"
                      }`} />
                    </div>
                    <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-2 rounded-lg bg-slate-50 p-2 dark:bg-gray-700/50">
                    <div className={`flex flex-shrink-0 items-center justify-center rounded-lg bg-amber-100 dark:bg-amber-900/30 ${
                      isGridView ? "h-6 w-6" : "h-8 w-8"
                    }`}>
                  ...
                  <div className="flex items-center gap-2 rounded-lg bg-slate-50 p-2 dark:bg-gray-700/50">
                    <div className={`flex flex-shrink-0 items-center justify-center rounded-lg bg-purple-100 dark:bg-purple-900/30 ${
                      isGridView ? "h-6 w-6" : "h-8 w-8"
                    }`}>
                      <TbManualGearbox className={`text-purple-600 dark:text-purple-400 ${
                        isGridView ? "h-3 w-3" : "h-4 w-4"
                      }`} />
                    </div>
                    <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-2 rounded-lg bg-slate-50 p-2 dark:bg-gray-700/50">
                    <div className={`flex flex-shrink-0 items-center justify-center rounded-lg bg-rose-100 dark:bg-rose-900/30 ${
                      isGridView ? "h-6 w-6" : "h-8 w-8"
                    }`}>
                      <IoIosColorPalette className={`text-rose-600 dark:text-rose-400 ${
                        isGridView ? "h-3 w-3" : "h-4 w-4"
                      }`} />
                    </div>
                    <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-2 rounded-lg bg-slate-50 p-2 dark:bg-gray-700/50">
                    <div className={`flex flex-shrink-0 items-center justify-center rounded-lg bg-indigo-100 dark:bg-indigo-900/30 ${
                      isGridView ? "h-6 w-6" : "h-8 w-8"
                    }`}>
                      <GiCarSeat className={`text-indigo-600 dark:text-indigo-400 ${
                        isGridView ? "h-3 w-3" : "h-4 w-4"
                      }`} />
                    </div>
                    <div className="min-w-0 flex-1">
