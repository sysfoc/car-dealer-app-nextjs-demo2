...
export default function Header({ logo: initialLogo, topSettings }) {
  ...
  const handleLikedCars = () => router.push("/liked-cars");
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-4">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <button
                onClick={handleLogin}
                className="hidden items-center space-x-2 rounded-xl bg-gray-100 px-4 py-3 text-gray-600 hover:bg-gray-200 hover:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-blue-400 lg:flex"
              >
              ...
              <button
                ...
                className="rounded-xl bg-gray-100 p-3 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 lg:hidden"
              >
              ...
              <button
                ...
                className="hidden rounded-xl bg-gray-100 p-3 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 lg:block"
              >
              ...
              {!topSettings?.hideFavourite && (
                <button
                  ...
                  className="hidden rounded-xl bg-gray-100 p-3 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 md:flex"
                >
              ...
              {!topSettings?.hideDarkMode && (
                <button
                  ...
                  className="rounded-xl bg-gray-100/70 p-3 text-gray-700 dark:bg-gray-700/70 dark:text-gray-300"
                >
