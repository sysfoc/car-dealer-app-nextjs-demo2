...
const Header = () => {
  ...
  const fetchSettings = useCallback(async () => {
    ...
    if (globalSettingsCache && Date.now() - globalCacheTimestamp < CACHE_DURATION) {
      const cachedData = globalSettingsCache;
    ...
    try {
      ...
      if (updates.logo) setLogo(updates.logo);
  ...
  useEffect(() => {
    ...
    const taskId = scheduleTask(() => fetchSettings());
  ...
  // Simple skeleton without animations
