...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Flexible add-on options tailored to your budget. Get pre-approved quickly and drive away with confidence in your investment.",
