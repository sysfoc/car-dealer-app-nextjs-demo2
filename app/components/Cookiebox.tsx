...
//     // Store analytics settings in localStorage
//     if (data.settings?.analytics) {
//       setLocalStorage("analytics_settings", {
...
//      // Get analytics settings from local storage
//      const analyticsSettings = getLocalStorage("analytics_settings", null);
     
//      // Only update if analytics is active
//      if (analyticsSettings?.status === 'active') {
...
//        });
//      } else {
//        console.log('Google Analytics is inactive, skipping consent update');
//      }
//    }
