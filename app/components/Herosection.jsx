...
// // Static content to prevent layout shifts
...
//   const deferredHeading = useDeferredValue(headingData); // Prevent layout shifts
...
//     // Delay API call to prioritize initial render
...
//   // Use deferred value to prevent layout shifts
//   const parts = splitHeadingAfterTwoWords(deferredHeading);
//   const textSizeClass = getResponsiveTextSize(deferredHeading);
