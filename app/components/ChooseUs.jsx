...
//       {/* Animated background elements */}
//       <div className="absolute top-0 left-0 w-60 h-60 bg-blue-500/20 rounded-full blur-3xl animate-pulse"></div>
...
//           <div className="text-center mb-8 space-y-3">
//             <div className="inline-block">
//               <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-5 py-2 mb-2">
...
//             <p className="text-base text-blue-100/80 max-w-2xl mx-auto leading-relaxed">
//               Experience the difference with our premium automotive services and customer-first approach
//             </p>
...
//               <div
//                 key={index}
//                 className="group relative backdrop-blur-md bg-white/10 hover:bg-white/15 border border-white/20 hover:border-white/30 rounded-xl p-5 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25"
//               >
//                 {/* Background glow effect */}
//                 <div className={`absolute inset-0 ${feature.bgColor} ${feature.hoverBgColor} rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
...
//                     {/* Floating particles effect */}
//                     <div className="absolute -top-1 -right-1 w-2 h-2 bg-white/30 rounded-full opacity-0 group-hover:opacity-100 group-hover:animate-ping transition-opacity duration-300"></div>
//                   </div>

//                   {/* Text content */}
//                   <div className="space-y-2">
//                     <h3 className="text-base font-bold text-white group-hover:text-blue-100 transition-colors duration-300">
//                       {feature.title}
//                     </h3>
//                     <p className="text-blue-100/70 group-hover:text-blue-100/90 leading-relaxed text-sm transition-colors duration-300">
//                       {feature.description}
//                     </p>
//                   </div>
...
//                   <div className="flex items-center space-x-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
//                     <div className={`w-5 h-0.5 bg-gradient-to-r ${feature.color} rounded-full`}></div>
//                     <span className="text-xs text-blue-200 font-medium">Learn More</span>
//                   </div>
//                 </div>

//                 {/* Border glow effect */}
//                 <div className={`absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-r ${feature.color} p-[1px]`}>
//                   <div className="w-full h-full rounded-xl bg-slate-900"></div>
//                 </div>
//               </div>
//             ))}
//           </div>
...
//           {/* Bottom CTA Section */}
//           <div className="mt-12 text-center">
//             <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-xl p-5 max-w-3xl mx-auto">
//               <h3 className="text-xl md:text-2xl font-bold text-white mb-2">
//                 Ready to Experience the Difference?
//               </h3>
//               <p className="text-blue-100/80 mb-5 text-base">
//                 Join thousands of satisfied customers who chose excellence
//               </p>
//               <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
...
//                   Browse Our Inventory
//                 </button>
//                 <button className="bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white font-semibold px-6 py-2.5 rounded-lg border border-white/30 hover:border-white/50 transition-all duration-300 text-sm">
//                   Contact Us Today
//                 </button>
//               </div>
//             </div>
